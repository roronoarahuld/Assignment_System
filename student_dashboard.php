...
<head>
	...
	<title>Engineering Projects - Student Dashboard</title>
				...
				<div class="content-row">
					...
					<div class="right-panel-cont">
						<div class="submitted-assignment">
							...
							<div class="list-assign">
								<div class="list-div">
									...
									<span class="file-title">
										<a href="submitted-stu-assignment.php">Subject 1</a>
									</span>
							...
							<a href="submitted-stu-assignment-list.php">See More</a>
						</div>
					</div>
				</div>
				<div class="content-row">
					...
					<div class="right-panel-cont">
						<div class="pending-assignment">
							<span>Pending Assignment by the Experts</span>
							<div class="list-assign">
								<div class="list-div">
									<span class="file-img"><i class="far fa-file-alt"></i></span>
									<span class="file-title">
										<a href="pending-stu-assignment.php">Subject 1</a>
									</span>
									<span class="file-date">
										Date Created<br/>
										19-07-18
							...
							<a href="pending-stu-assignment-list.php">See More</a>
						</div>
					</div>
				</div>
			</div>
